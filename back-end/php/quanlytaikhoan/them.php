...
<head>
    ...
    <link href="/Thời trang nam casual/back-end/css/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="them_xu_ly.php" method="post" class="user">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="name_admin" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Enter your full name">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="date" name="dateOfBirth" class="form-control form-control-user"
                                            id="exampleInputDateOfBirth" placeholder="Your date of birth">
                                    </div>
