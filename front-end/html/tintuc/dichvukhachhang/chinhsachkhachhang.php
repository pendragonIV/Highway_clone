...
<head>
    ...
    <title>CHÍNH SÁCH KHÁCH HÀNG</title>
...
<body>
    ...
    <div class="body__banner--content">
        <img class="imgbannercontent" src="/Thời trang nam casual/front-end/img/imgtintuc/imgChinhsach1.jpg" alt="">
    </div>
    <div class="body__container--content" style="display: flex; align-items: flex-start;">
        <div class="body__text--content" style="display: flex; align-items: flex-start;">
            <p>1. QUY TẮC TÍCH ĐIỂM <br>
                Điểm tích lũy sẽ được chúng tôi quy đổi như sau: <br>
                Mua hàng: 10.000 VNĐ = 1 điểm <br>
                <br>
                Số điểm được sử dụng để quy đổi sang các hạng mức thẻ, không có giá trị quy đổi thành tiền mặt & không được trừ vào các hóa đơn mua hàng.</p>
            <p>2. CÁC QUYỀN LỢI CÁC HẠNG THẺ TẠI HIGHWAY.</p>
        </div>
        <div class="body__image--revival">
            <img class="imgrevival" src="/Thời trang nam casual/front-end/img/imgtintuc/chinhsachkhachang.png" alt="">
        </div>
