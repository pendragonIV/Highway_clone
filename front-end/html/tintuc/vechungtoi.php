...
<head>
    ...
    <link rel="stylesheet" href="/Thời trang nam casual/front-end/css/tintuc/tintuc.css">
...
<body>
    ...
    <div class="body_blog">
        <div class="container-fluid">
            <div class="blog__title">
                <a href="#">
                    <img class="body__title--img" src="/Thời trang nam casual/front-end/img/imgtintuc/imgTitleAboutus.jpg" alt="">
                </a>
            </div>
            <div class="body__newblog">
                <div class="body__box">
                    <div class="zoom">
                        <a href="/Thời trang nam casual/front-end/html/tintuc/vechungtoi/thongtincuahang.php">
                            <img class="imgBlog" src="/Thời trang nam casual/front-end/img/imgtintuc/imgBlog1.jpg" alt="">
                        </a>
                    </div>
                    <a class="body__blog--text" href="#">
                        <p>HIGHWAY MENSWEAR</p>
                    </a>
                </div>
                <div class="body__box">
                    <div class="zoom">
                        <a href="/Thời trang nam casual/front-end/html/tintuc/vechungtoi/thongtinlienhe.php">
                            <img class="imgBlog" src="/Thời trang nam casual/front-end/img/imgtintuc/imgBlog2.jpg " alt="">
                        </a>
                    </div>
                    <a class="body__blog--text" href="#">
    ...
    <div class="main-footer" style=" margin-top:250px; ">
        <div class="container-fluid">
